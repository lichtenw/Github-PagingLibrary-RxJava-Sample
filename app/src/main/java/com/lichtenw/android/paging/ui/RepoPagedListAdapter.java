 ...
 */
public class RepoPagedListAdapter extends PagedListAdapter<Repo, RepoViewHolder> {


    public RepoPagedListAdapter() {
        super(DIFF_CALLBACK);
    }
    ...
    static DiffUtil.ItemCallback<Repo> DIFF_CALLBACK = new DiffUtil.ItemCallback<Repo>() {
